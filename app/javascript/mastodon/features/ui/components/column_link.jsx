...
const ColumnLink = ({ icon, text, to, href, method, badge, transparent, targetWindow, ...other }) => {
  ...
  if (href) {
    return (
      <a href={href} className={className} data-method={method} title={text} target={targetWindow} {...other}>
        {iconElement}
        <span>{text}</span>
        {badgeElement}
      </a>
